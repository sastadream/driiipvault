        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              {department.name} • {semester.description || "Select a subject to browse files"}
            </p>
          </div>
          <Link href={`/departments/${departmentId}/semesters`}>
              ...
              <Card key={subject.id} className="hover:shadow-lg">
                ...
                <CardContent>
                  <div className="flex flex-col gap-3">
                    ...
                    <Link href={`/departments/${departmentId}/semesters/${semesterId}/subjects/${subject.id}/files`}>
