      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Select a department to upload your files</p>
          </div>
        </div>

        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {departments?.map((department) => (
            <Card key={department.id} className="hover:shadow-lg transition-shadow cursor-pointer group">
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-gray-600">
                No departments have been set up yet. Contact your administrator to add departments.
              </p>
            </CardContent>
          </Card>
        )}
